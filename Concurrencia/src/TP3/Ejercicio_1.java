        ...
        public void run() {
            for (int i = 0; i <= 3; i++) {
                ...
                if (i == 3 && Thread.currentThread().getName() == "Luis") {
                    System.out.println("Ultimos datos de Luis, debe ser igual a 50 " + this.cb.getBalance());
                }
                if(i == 3 && Thread.currentThread().getName() == "Manuel")
                           System.out.println("Ultimos datos de Manuel, debe ser igual a 10 " + this.cb.getBalance());
            }
        }
